...
import { blurHandler, checkDscrProd, checkImg, checkNumber, checkProdName } from "../CheckForm/Checking";
import { ErrorBlock } from "../Errors/ErrorBlock";
import {updateProd } from "../ApiFunction/function";

const EditProd = 
   ({id, title, descr, cost, categ, brand, nameImg, setActive, setState}) => {
      ...
      <>
         ...
         <form className="modal__form">
            <div className="form-block">
               <label>ID</label>
               <input type="text" className="input-form" name="idProd" value={id} disabled/>
            </div>
            <div className="form-block">               
               {ErrorBlock(nameProdDirty, nameProdErr)}
               <label>Название товара</label>
               <input type="text" className="input-form" name="titleProd" 
               value={nameProd} placeholder={title} 
            ...
            <div className="form-block">               
               ...
               value={dscrProd} placeholder={descr} 
            ...
            <div className="form-block">
               ...
               <input type="text" className="input-form" name="costProd" 
               value={costProd} placeholder={cost} 
            ...
            <div className="form-block">
               ...
               <input type="text" className="input-form" name="brandProd" 
               value={brandProd} placeholder={brand} 
            ...
            <div className="form-block">               
               ...
               <input type="text" className="input-form" name="imgProd" 
               value={nameImgProd} placeholder={nameImg} 
            ...
            <div className="form-block">
               ...
               <input type="text" className="input-form" name="categ" 
               value={categProd} placeholder={categ} 
            ...
            <button disabled={!valid} type="button" className="btn"
               onClick={() => {
                  updateProd(id, nameProd, dscrProd, costProd, categProd,  brandProd,  nameImgProd, setNameProd, setDscrProd, setCostProd, setCategProd, setBrandProd ,setNameImgProd, setActive, setState);
               }}
            >Изменить товар
            </button>
         </form>
